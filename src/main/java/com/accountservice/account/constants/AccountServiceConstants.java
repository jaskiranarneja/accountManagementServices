...
public class AccountServiceConstants {
    ...
    public static final String NAME_INVALID_SIZE = "Name size must be between 1 and 20";

    public static final String COUNTRY_MESSAGE = "Please provide country";
    public static final String ACCOUNT_ID_MESSAGE = "Please provide an account id";
    public static final String SECURITY_PIN_MESSAGE = "Please provide the security pin";
